...
import { Car, CatalogClientProps } from "@/lib/definitions";
...
export default function CatalogClient({
  ...
  return (
    <SidebarProvider>
      <div className="container mx-auto h-full flex min-h-screen py-12">
        {/* Barra lateral */}
        <Sidebar className="w-64 bg-gray-800 text-white mt-28 rounded-lg h-max">
        ...
        <div className="flex-1 bg-white ml-6 mt-16">
          ...
          <h1 className="text-3xl font-bold mb-12 ">Concesionario de coches de segunda mano, de ocasión y km 0</h1>
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold">
              Se han encontrado 156 vehículos
            </h2>
            <select className="border rounded-md px-4 py-2">
              <option>Los más recientes</option>
              <option>Precio: menor a mayor</option>
              <option>Precio: mayor a menor</option>
              <option>Kilómetros: menor a mayor</option>
            </select>
          </div>
          {/* LISTADO DE COCHES */}
          {cars.length === 0 ? (
