        ...
        <section className="bg-gray-900 text-primary-foreground py-16 mt-16">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl text-center mb-8 max-w-2xl mx-auto">
              Estamos aquí para ayudarte. Ponte en contacto con nosotros para cualquier consulta o visita nuestro
              concesionario.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="flex flex-col max-md:items-center">
                ...
                <p className="max-md:text-center text-lg text-muted-foreground mb-8">
                  Visita nuestro concesionario y descubre nuestra amplia selección de vehículos. Nuestro equipo estará
                  encantado de atenderte y ayudarte a encontrar el coche perfecto para ti.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground">
                  Encuentra respuestas a las preguntas más comunes sobre nuestros servicios y horarios.
                </p>
              </div>
              <Faq />
            </div>
